...
const Home = () => {
  ...
  return (
    <main className="min-h-screen bg-cyber-black text-cyber-white overflow-hidden relative">
          ...
          <div className="max-w-4xl w-full mt-16 md:mt-0">
            ...
            >
              <div className="space-y-2">
                ...
                <motion.div
                  className="flex items-center gap-3 text-xs md:text-sm font-tech"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-6">
                  <p className="text-cyber-white/80">
                    I am currently a Sophomore at <a href="https://eecs.engin.umich.edu/" className="text-neon-blue hover:underline">the University of Michigan</a>, 
                    looking to work in hardware engineering, full stack development, and crypto. 
                    I'm fascinated by technical, large scale products that are changing the technological landscape.
                  </p>
                  <p className="text-cyber-white/80">
                    Outside of work, I'm interested in drones, cars, the outdoors, and sneakers. 
                    And I'm always interested in learning more, whether it be through reading, podcasts, or hands-on projects.
                  </p>
                </div>
                <div>
      ...
      {/* Credits */}
      <footer className="py-8 text-center text-cyber-white/60 font-tech text-sm">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
      ...
      {/* Contact Button */}
      <motion.div
        className="fixed bottom-8 right-8 flex flex-col items-end gap-2 hidden md:flex"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 1.4 }}
      >
